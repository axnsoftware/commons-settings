...
/**
 * The class DefaultSettings models a concrete implementation of the
 * {@code Settings} interface.
 *
 * @since 1.0.0
 */
class DefaultSettings<T> implements Settings<T> {
  ...
  DefaultSettings(T properties, Accessor rootAccessor, SettingsStore<T> settingsStore) {
  ...
  public ProblemReporter validate() {
    ...
    ProblemReporter problemReporter = new DefaultProblemReporter(this);
