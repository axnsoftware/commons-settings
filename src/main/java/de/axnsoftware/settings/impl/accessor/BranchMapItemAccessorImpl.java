...
/**
 * The final class BranchMapItemAccessorImpl models a concrete implementation of
 * the {@code IAccessor} interface, responsible for accessing items in
 * {@code Map}S that are instances of {@code PropertyClass} annotated classes.
 *
 * @author Carsten Klein "cklein" <carsten.klein@axn-software.de>
 * @since 1.0.0
 */
public final class BranchMapItemAccessorImpl extends AbstractMapItemAccessorImpl {
