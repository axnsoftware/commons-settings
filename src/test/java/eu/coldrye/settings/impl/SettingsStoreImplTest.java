...
public class SettingsStoreImplTest {
  ...
  public void constructorMustFailOnNullBackingStore() {
    ...
    Assertions.assertThrows(IllegalArgumentException.class, () -> {
      new SettingsStoreImpl(null, rootAccessorMock, CustomTypeSettingsRoot.class);
    });
  }
  ...
  public void constructorMustFailOnNullRootAccessor() {
    ...
    Assertions.assertThrows(IllegalArgumentException.class, () -> {
      new SettingsStoreImpl(backingStoreMock, null, CustomTypeSettingsRoot.class);
    });
  }
  ...
  public void deleteSettingsMustDelegateToBackingStore() throws Exception {
    ...
    BackingStore backingStoreMock = Mockito.mock(BackingStore.class);
    Accessor rootAccessorMock = Mockito.mock(Accessor.class);
    new SettingsStoreImpl(backingStoreMock, rootAccessorMock, CustomTypeSettingsRoot.class).deleteSettings();
  ...
  public void getBackingStoreMustReturnExpectedValue() throws Exception {
    ...
    BackingStore backingStoreMock = Mockito.mock(BackingStore.class);
    Accessor rootAccessorMock = Mockito.mock(Accessor.class);
    Assertions.assertSame(backingStoreMock, new SettingsStoreImpl(backingStoreMock, rootAccessorMock,
  ...
  public void getTypeMustReturnExpectedValue() throws Exception {
    ...
    BackingStore backingStoreMock = Mockito.mock(BackingStore.class);
    Accessor rootAccessorMock = Mockito.mock(Accessor.class);
    Assertions.assertSame(CustomTypeSettingsRoot.class, new SettingsStoreImpl(backingStoreMock, rootAccessorMock,
  ...
  public void loadSettingsMustReturnProperlyConfiguredSettings() throws Exception {
    ...
    BackingStore backingStoreMock = Mockito.mock(BackingStore.class);
    Accessor rootAccessorMock = Mockito.mock(Accessor.class);
    SettingsStore store = new SettingsStoreImpl(backingStoreMock, rootAccessorMock, CustomTypeSettingsRoot.class);
  ...
  public void loadSettingsMustFailOnSettingsRootWithprivateDefaultConstructor() throws Exception {
    ...
    BackingStore backingStoreMock = Mockito.mock(BackingStore.class);
    Accessor rootAccessorMock = Mockito.mock(Accessor.class);
    SettingsStore store = new SettingsStoreImpl(backingStoreMock, rootAccessorMock,
