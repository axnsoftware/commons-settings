...
import eu.coldrye.settings.impl.accessor.BranchPropertyAccessorImpl;
import eu.coldrye.settings.util.VisitorUtils;

import java.lang.reflect.Field;

/**
 * The class PropertyClassFieldVisitorImpl models a concrete implementation of the {@code Visitor} interface that is
...
public class PropertyClassFieldVisitorImpl extends AbstractFieldVisitorImpl {
  ...
  public PropertyClassFieldVisitorImpl(Visitor<Class<?>> propertyClassVisitor) {
  ...
  public void visit(Field visitee, Accessor parentAccessor) {
    ...
    PropertyAccessor accessor = new BranchPropertyAccessorImpl();
