 ...
 *
 */
public abstract class AbstractContainerFieldVisitor extends AbstractFieldVisitor {
  ...
  public AbstractContainerFieldVisitor(Visitor<Class<?>> propertyClassVisitor) {

    this.visitors = new ArrayList<>();
    this.visitors.add(propertyClassVisitor);
    this.visitors.addAll(Arrays.asList(SimpleTypeVisitor.getPreparedSimpleTypeVisitors()));
    this.visitors.add(new FailFastVisitor<>());
  }
