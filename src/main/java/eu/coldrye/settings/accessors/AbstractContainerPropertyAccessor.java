...
/**
 * The abstract class AbstractContainerPropertyAccessor models the root of a
 ...
 * @since 1.0.0
 */
public abstract class AbstractContainerPropertyAccessor<T> extends AbstractPropertyAccessor
  implements ContainerPropertyAccessor<T> {

  private ContainerItemAccessor<T>  itemAccessorTemplate;

  protected AbstractContainerPropertyAccessor() {
  ...
  public final Object clone() {
    ...
    AbstractContainerPropertyAccessor result = (AbstractContainerPropertyAccessor) super.clone();
