...
/**
 * The class AbstractFieldVisitor models a concrete implementation of
 ...
 * @since 1.0.0
 */
public class PropertyClassVisitor implements Visitor<Class<?>> {

  private List<Visitor<Field>> fieldVisitors;

  public PropertyClassVisitor() {

    fieldVisitors = new ArrayList<>();
    fieldVisitors.add(new ArrayFieldVisitor(this));
    fieldVisitors.add(new ListFieldVisitor(this));
    fieldVisitors.add(new MapFieldVisitor(this));
    fieldVisitors.add(new PropertyClassFieldVisitor(this));
    fieldVisitors.addAll(Arrays.asList(SimpleTypeFieldVisitor.getPreparedSimpleTypeFieldVisitors()));
    fieldVisitors.add(new FailFastVisitor<>());
  }
