...
/**
 * The class LeafPropertyAccessor models a concrete implementation of
 * the {@code Accessor} interface, responsible for accessing simple type
 * fields, such as {@code Integer} or {@code Enum}S.
 *
 * @since 1.0.0
 */
public class LeafPropertyAccessor extends AbstractPropertyAccessor implements LeafItemAccessor {
