...
/**
 * The class DefaultPropertiesBackingStore models a concrete implementation
 * of the {@link BackingStore} interface.
 *
 * @since 1.0.0
 */
class DefaultPropertiesBackingStore implements BackingStore {
  ...
  DefaultPropertiesBackingStore(FileFormat fileFormat, File storagePath) {
