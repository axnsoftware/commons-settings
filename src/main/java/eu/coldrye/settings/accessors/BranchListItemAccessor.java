...
/**
 * The class BranchListItemAccessor models a concrete implementation
 ...
 * @since 1.0.0
 */
public class BranchListItemAccessor extends AbstractContainerItemAccessor<Integer> implements ListItemAccessor {
